...
@SessionScoped
@Named("medicalDoctorCertificateListMB")
public class MedicalDoctorCertificateListMB extends BaseListMB<MedicalCertificate> {
	...
	public List<MedicalCertificate> list() {
		...
		List<MedicalCertificate> listByCertifiedId = medicalCertificateService.listByIssuerId(currentUser.getId(),isListValidOnly());
