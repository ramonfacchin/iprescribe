 ...
 * generated in the br.com.bry.samplews.generated package. 
...
public class ObjectFactory {
    ...
    private final static QName _FindByKey_QNAME = new QName("http://impl.service.bry.com.br/", "findByKey");
    private final static QName _GetResponse_QNAME = new QName("http://impl.service.bry.com.br/", "getResponse");
    private final static QName _DatabaseConfiguration_QNAME = new QName("http://impl.service.bry.com.br/", "databaseConfiguration");
    private final static QName _FindByKeyResponse_QNAME = new QName("http://impl.service.bry.com.br/", "findByKeyResponse");
    private final static QName _Get_QNAME = new QName("http://impl.service.bry.com.br/", "get");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.com.bry.samplews.generated
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.bry.com.br/", name = "findByKey")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.bry.com.br/", name = "getResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.bry.com.br/", name = "databaseConfiguration")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.bry.com.br/", name = "findByKeyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.bry.com.br/", name = "get")
